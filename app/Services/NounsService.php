...
class NounsService implements ERC721ServiceContract, NounsServiceContract {
    protected $web3;
    protected $contract;
    ...
    public function __construct(Web3 $web3) {
        ...
        $contractAddress = config('services.nouns_contract.address');
    ...
    public function getMintEvent(int $tokenId): array 
    {
        ...
        $filters = [
            ...
            'address' => config('services.nouns_contract.address'), // The contract address
            'topics' => [
