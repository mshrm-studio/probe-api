...
class SyncLilNounTokenColors implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        foreach ($lilNouns as $lilNouns) {          
            $imagick = new \Imagick();

            $svgContent = Storage::get($lilNouns->svg_path);
    ...
    private function convertHexToRGB(string $hexColor): array
    {
        ...
        if (strlen($hexColor) == 6) {
            ...
            throw new \Exception('SyncLilNounTokenColors, convertHexToRGB(): Invalid hex color');
        }
