...
<head>
    ...
    @if ($hasMore)
        <meta property="fc:frame:post_url" content="https://api.probe.wtf/api/warpcast-frames/nouns/next/{{ $noun->token_id }}" />
        <meta property="fc:frame:button:3" content="Next" />
        <meta property="fc:frame:button:3:action" content="post" />
        <meta property="fc:frame:button:3:post_url" content="https://api.probe.wtf/api/warpcast-frames/nouns/next/100" />
    @endif
</head>
<body>
