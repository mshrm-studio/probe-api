...
<head>
    ...
    @if ($noun->token_id >= 0)
        @if ($noun->token_id > 0)
            ...
            <meta property="fc:frame:button:3:post_url" content="https://api.probe.wtf/api/warpcast-frames/previous-noun?noun={{ $noun->token_id }}" />
        @endif

        @if ($noun->token_id > 0 && $hasMore) 
            <meta property="fc:frame:button:4" content="Next" />
            <meta property="fc:frame:button:4:action" content="post" />
            <meta property="fc:frame:button:4:post_url" content="https://api.probe.wtf/api/warpcast-frames/next-noun?noun={{ $noun->token_id }}" />
        @elseif ($hasMore)
            <meta property="fc:frame:button:3" content="Next" />
            <meta property="fc:frame:button:3:action" content="post" />
            <meta property="fc:frame:button:3:post_url" content="https://api.probe.wtf/api/warpcast-frames/next-noun?noun={{ $noun->token_id }}" />
        @endif
    @endif    
</head>
<body>
